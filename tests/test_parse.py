...
def test_parse_symph_tqqq_ftlt():
  ...
  expected_algo = ('wteq', (('wteq', (('ifelse', ('gt', ('now', ('asset', 'SPY')), ('ma', ('asset', 'SPY'), 200)), ('wteq', (('ifelse', ('gt', ('rsi', ('asset', 'TQQQ'), 10), ('number', 79.0)), ('asset', 'VIXY'), ('wteq', (('ifelse', ('gt', ('rsi', ('asset', 'SPXL'), 10), ('number', 80.0)), ('asset', 'VIXY'), ('wteq', (('asset', 'TQQQ'),))),))),)), ('wteq', (('ifelse', ('lt', ('rsi', ('asset', 'TQQQ'), 10), ('number', 31.0)), ('asset', 'TECL'), ('wteq', (('ifelse', ('lt', ('rsi', ('asset', 'SPY'), 10), ('number', 30.0)), ('asset', 'UPRO'), ('wteq', (('ifelse', ('lt', ('now', ('asset', 'TQQQ')), ('ma', ('asset', 'TQQQ'), 20)), ('wteq', (('filter', (('asset', 'SQQQ'), ('asset', 'TLT')), ('rsi', 10), ('top', 1)),)), ('wteq', (('ifelse', ('lt', ('rsi', ('asset', 'SQQQ'), 10), ('number', 31.0)), ('asset', 'SQQQ'), ('asset', 'TQQQ')),))),))),))),))),)),))
...
def test_parse_symph_basic_ifelse():
  ...
  expected_algo =  ('wteq', (('ifelse', ('gt', ('rsi', ('asset', 'SPY'), 10), ('number', 60.0)), ('asset', 'BIL'), ('asset', 'TQQQ')),))
  algo = parse(symphony_json)
...
def test_parse_wtspec():
  ...
  expected_algo = ('wtspec', (('asset', 'asset1'), ('asset', 'asset2')), ((90, 100), (10, 100)))
...
def test_parse_wtinvol():
  ...
  expected_algo = ('wtinvol', (('asset', 'asset1'), ('asset', 'asset2')), 10)
