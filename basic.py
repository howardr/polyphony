...
price_data_start = utils.subtract_trading_days(
  date, 201
)  # need >= 200 days of data for SPY 200d MA
price_data_end = date + datetime.timedelta(days=1)
price_data = yf.download(
  "SPY TQQQ BIL", start=price_data_start, end=price_data_end, progress=False
)
